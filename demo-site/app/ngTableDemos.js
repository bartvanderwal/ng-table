(function () {
  ...
  angular.module("ngTableDemos").factory("ngTableSimpleList", ngTableSimpleList);

  function ngTableSimpleList() {
    return [
  ...
  angular.module("ngTableDemos").factory("ngTableGroupedList", ngTableGroupedList);

  function ngTableGroupedList() {
    return [
      ...
      /* { "name": "Cat", "age": 57, "money": 746, "country": "China" }, { "name": "Christian", "age": 59, "money": 572, "country": "Canada" }, { "name": "Tony", "age": 60, "money": 649, "country": "Japan" }, { "name": "Cat", "age": 47, "money": 675, "country": "Denmark" }, { "name": "Stephane", "age": 50, "money": 674, "country": "China" }, { "name": "Markus", "age": 40, "money": 549, "country": "Portugal" }, { "name": "Anthony", "age": 53, "money": 660, "country": "Bahamas" }, { "name": "Stephane", "age": 54, "money": 549, "country": "China" }, { "name": "Karen", "age": 50, "money": 611, "country": "American Samoa" }, { "name": "Therese", "age": 53, "money": 754, "country": "China" }, { "name": "Bismark", "age": 49, "money": 791, "country": "Canada" }, { "name": "Daraek", "age": 56, "money": 640, "country": "Costa Rica" }, { "name": "Tony", "age": 43, "money": 674, "country": "Canada" }, { "name": "Karen", "age": 47, "money": 700, "country": "Portugal" }, { "name": "Therese", "age": 47, "money": 718, "country": "Czech Republic" }, { "name": "Karen", "age": 50, "money": 655, "country": "Japan" }, { "name": "Daraek", "age": 59, "money": 581, "country": "American Samoa" }, { "name": "Daraek", "age": 60, "money": 595, "country": "Portugal" }, { "name": "Markus", "age": 44, "money": 607, "country": "China" }, { "name": "Simon", "age": 58, "money": 728, "country": "Japan" },*/
      { "name": "Simon", "age": 49, "money": 655, "country": "Bahamas" } 
    ];
  }

  angular.module("ngTableDemos").factory("ngTableDemoCountries", ngTableDemoCountries);
  
  ngTableDemoCountries.$inject = ["ngTableSimpleMediumList"];
  
  function ngTableDemoCountries(ngTableSimpleMediumList) {
  ...
  angular.module("ngTableDemos").factory("ngTableNestedMediumList", ngTableNestedMediumList);
  
  ngTableNestedMediumList.$inject = ["ngTableSimpleMediumList"];
  
  function ngTableNestedMediumList(ngTableSimpleMediumList) {
  ...
  angular.module("ngTableDemos").factory("ngTableSimpleMediumList", ngTableSimpleMediumList);
  
  function ngTableSimpleMediumList() {
